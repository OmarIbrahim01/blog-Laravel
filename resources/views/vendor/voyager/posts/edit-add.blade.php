            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i>Post Subtitle
                                <span class="panel-desc">Subtitle for your post
                                </span>
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                        ...
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="title" name="sub_title" placeholder="Subtitle" value="@if(isset($dataTypeContent->sub_title)){{ $dataTypeContent->sub_title }}@endif">
                        </div>
                    </div>
